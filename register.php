...
include("init.php"); 
   ...
   if (isset($_POST['submit'])) 
   {
     $data = 
      ...
      {
        $lname = htmlspecialchars($data['fname']);
      }
      else
      {
        $lname = null;
      ...
      {    
        if($source->sqlquery("INSERT INTO `user` (`fname`, `lname`, `emailid`, `password`) VALUES ('$fname','$lname','$email','$pass')"))
        {
          $run = $source->Single();
          $alert = true;
